...
public:
	...
	t_key	GetDataRangeLength(t_data * content)
	{
		Entry	* entry = reinterpret_cast <Entry *>(reinterpret_cast <UInt8 *>(content) - offsetof(Entry, content));
