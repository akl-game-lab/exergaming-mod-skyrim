...
bool Setting::GetDouble(double * out) const
{
	switch(GetType())
	{
		case kType_Integer:	*out = content.s32; break;
		case kType_Float:	*out = content.f32; break;
		case kType_String:	return false;
		case kType_Bool:	*out = content.u8 ? 1 : 0; break;
		case kType_ID6:		*out = content.u32 >> 8; break;
		case kType_ID:		*out = content.u32; break;
...
bool Setting::SetDouble(double value)
{
	switch(GetType())
	{
		case kType_Integer:	content.s32 = value; break;
		case kType_Float:	content.f32 = value; break;
		case kType_String:	return false;
		case kType_Bool:	content.u8 = value ? 1 : 0; break;
		case kType_ID6:		content.u32 = ((UInt32)value) << 8; break;
		case kType_ID:		content.u32 = value; break;
		default:			return false;
		case kType_Unknown:	return false;
	}
...
bool Setting::SetString(const char * value)
{
	...
	{
		if(name[0] == 'S')
			FormHeap_Free(content.s);

		content.s = FormHeap_Strdup(value);
