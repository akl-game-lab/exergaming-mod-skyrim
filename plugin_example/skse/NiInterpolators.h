...
public:
	...
	virtual bool	Update(float delta, NiObjectNET * target, NiQuatTransform * content);
	virtual bool	Update(float delta, NiObjectNET * target, NiColorA * content);
	virtual bool	Update(float delta, NiObjectNET * target, NiPoint3 * content);
	virtual bool	Update(float delta, NiObjectNET * target, NiQuaternion * content);
	virtual bool	Update(float delta, NiObjectNET * target, float * content);
	virtual bool	Update(float delta, NiObjectNET * target, bool * content);
