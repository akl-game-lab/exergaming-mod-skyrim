...
public:
	...
	struct Ref
	{
		...
		bool operator==(const Ref& lhs) const { return content == lhs.content; }
		bool operator<(const Ref& lhs) const { return content < lhs.content; }
	};
...
typedef void (__cdecl * _CRC32_Calc4)(UInt32 * out, UInt32 content);
extern const _CRC32_Calc4 CRC32_Calc4;

typedef void (__cdecl * _CRC32_Calc8)(UInt32 * out, UInt64 content);
