...
#if NUM_PARAMS >= 1
		m_params.content[0].type = GetTypeID <T_Arg0>(registry);
#endif
#if NUM_PARAMS >= 2
		m_params.content[1].type = GetTypeID <T_Arg1>(registry);
#endif
#if NUM_PARAMS >= 3
		m_params.content[2].type = GetTypeID <T_Arg2>(registry);
#endif
#if NUM_PARAMS >= 4
		m_params.content[3].type = GetTypeID <T_Arg3>(registry);
#endif
#if NUM_PARAMS >= 5
		m_params.content[4].type = GetTypeID <T_Arg4>(registry);
#endif
#if NUM_PARAMS >= 6
		m_params.content[5].type = GetTypeID <T_Arg5>(registry);
#endif
#if NUM_PARAMS >= 7
		m_params.content[6].type = GetTypeID <T_Arg6>(registry);
#endif
#if NUM_PARAMS >= 8
		m_params.content[7].type = GetTypeID <T_Arg7>(registry);
#endif
#if NUM_PARAMS >= 9
		m_params.content[8].type = GetTypeID <T_Arg8>(registry);
#endif
#if NUM_PARAMS >= 10
		m_params.content[9].type = GetTypeID <T_Arg9>(registry);
#endif
