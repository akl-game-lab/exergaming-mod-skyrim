...
public:
	...
	*/
	...
	int getWorkoutsInDay(__int64 date);
	...
	*/
	...
	//Makes call to specified link
	void makeCall(std::string type, std::string url);
	...
	//Runs diagnostics and prints output to debug.txt
	void runDiagnosis(std::string email);
	...
	int getConfigProperty(std::string propertyname);
