...
namespace plugin
{
	...
	*/
	...
	//Runs diagnostics and outputs to debug.txt
	void runDiagnosis(StaticFunctionTag* base, BSFixedString email) {
		pluginFunctions.runDiagnosis(email.data);
	}
	...
	//Returns specified config property
	UInt32 getConfigProperty(StaticFunctionTag*base, BSFixedString propertyname) {
		return pluginFunctions.getConfigProperty(propertyname.data);
	}
	...
	*/
	...
	bool RegisterFuncs(VMClassRegistry* registry) {
		...
		registry->RegisterFunction(
			new NativeFunction1 <StaticFunctionTag, void, BSFixedString>("runDiagnosis", "PluginScript", plugin::runDiagnosis, registry));
		...
		registry->RegisterFunction(
			new NativeFunction1 <StaticFunctionTag, UInt32, BSFixedString>("getConfigProperty", "PluginScript", plugin::getConfigProperty, registry));
